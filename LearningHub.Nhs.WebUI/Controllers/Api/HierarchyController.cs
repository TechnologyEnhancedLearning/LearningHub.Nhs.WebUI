// <copyright file="HierarchyController.cs" company="NHS England">
...
namespace LearningHub.Nhs.WebUI.Controllers.Api
{
    ...
    public class HierarchyController : BaseApiController
    {
        ...
        {
            List<NodeContentEditorViewModel> viewModels = await this.hierarchyService.GetNodeContentsForCatalogueEditor(nodeId);
            return this.Ok(viewModels);
        }
