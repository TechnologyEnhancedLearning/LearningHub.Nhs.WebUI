<template>
    <div class="content-structure">
        <div v-if="(!isLoading && isReady)">
            ...
            <div id="content-structure-header" class="mt-3 mb-4">
                <div v-if="editMode === EditModeEnum.None && !publishInProgress">
                    <div class="d-flex button-bar">
                        <div><input id="editFolderStructureButton" type="button" class="nhsuk-button" @click="onEdit()" v-bind:value="editFolderStructureButtonText" :disabled="editFolderStructureButtonDisabled" /></div>
                        <div><span v-if="!(hierarchyEdit === null) && hierarchyEdit.hierarchyEditStatus === HierarchyEditStatusEnum.Draft" class="ml-auto"><i class="warning-triangle fa-solid fa-triangle-exclamation pr-3"></i>{{ hierarchyEdit.username }} is currently making changes to this folder structure</span></div>
                        <div class="mt-3">
                            <span v-if="!(hierarchyEdit === null) && !(hierarchyEdit.hierarchyEditStatus === HierarchyEditStatusEnum.Draft) && !(hierarchyEditLastPublished === null)">
                ...
                <div v-if="editMode === EditModeEnum.Structure" class="d-flex button-bar">
                    <div class="d-flex flex-row button-pair">
                        <input id="publishHierarchyEdit" type="button" class="nhsuk-button" @click="onPublish()" value="Publish changes" />
                        <input id="cancelHierarchyEdit" type="button" class="nhsuk-button nhsuk-button--secondary" @click="onCancelModal()" value="Cancel changes" />
                    </div>
                    <div class="d-flex flex-row">
                        <div class="ml-auto"><i class="text-warning fa-solid fa-triangle-exclamation pr-3 pt-3 pl-3"></i></div>
                ...
                <div v-if="publishInProgress">
                    <div class="mb-3"><i class="text-warning fa-solid fa-triangle-exclamation pr-3 pt-3"></i><h2 class="d-inline">Publish in progress</h2></div>
            ...
            <div id="treeView" v-if="!publishInProgress" v-show="editMode === EditModeEnum.Structure || editMode === EditModeEnum.None || editMode === EditModeEnum.MoveNode || editMode === EditModeEnum.MoveResource || editMode === EditModeEnum.ReferenceNode || editMode === EditModeEnum.ReferenceResource" class="node-contents-treeview">
            ...
            <div v-if="editMode === EditModeEnum.Folder" id="editFolder">
                ...
                <div class="col-12 d-flex" style="margin-top: 40px; margin-bottom: 40px;">
                    <input type="button" class="nhsuk-button nhsuk-u-margin-bottom-0 mr-3" @click="onSaveFolderEdit()" v-bind:class="{disabled: !canSaveFolderEdit}" v-bind:disabled="!canSaveFolderEdit" value="Save changes" />
                    <input type="button" class="nhsuk-button nhsuk-button--secondary nhsuk-u-margin-bottom-0" @click="onCancelFolderEdit()" value="Cancel" />
                    ...
                    <span v-if="editingFolderNode.nodeVersionId != 0 && editingFolderCanBeDeleted" class="ml-auto mt-3">
                        <a class="delete-folder-link" @click.prevent="onEditFolderDeleteFolder" href="#">
                            Delete this folder <i class="fa fa-trash-can delete-folder ml-2"></i>
                        </a>
                    </span>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header alert-modal-header text-center">
                            <h2 class="nhsuk-heading-l w-100"><i class="delete-folder-warning-triangle fa-solid fa-triangle-exclamation pr-3"></i>Delete folder</h2>
                        </div>
            ...
            <div id="cancelHierarchyEditModal" class="modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboad="false">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header alert-modal-header text-center">
                            <h2 class="nhsuk-heading-l w-100"><i class="cancel-hierarchy-edit-warning-triangle fa-solid fa-triangle-exclamation pr-3"></i>Cancel changes</h2>
                        </div>
                        ...
                        <div class="modal-footer alert-modal-footer">
                            <div class="form-group col-12 p-0 m-0">
                                <div class="d-flex button-pair">
                                    <input type="button" class="nhsuk-button" data-dismiss="modal" value="Continue Editing" />
                                    <input type="button" class="nhsuk-button nhsuk-button--secondary" @click="onCancelHierarchyEdit()" value="Cancel changes" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<style lang="scss" scoped>
    ...
    .d-flex.button-pair .nhsuk-button--reverse {
        border-color:#384853;
    }
    ...
    @media (max-width: 768px) {
        ...
        .btn-action-cancel, .btn-action-red, btn-admin-action, btn-admin-cancel {
            font-size: 1.6rem !important;
        }
    }
</style>