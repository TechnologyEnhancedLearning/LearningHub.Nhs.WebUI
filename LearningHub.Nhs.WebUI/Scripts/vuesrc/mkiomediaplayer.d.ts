...
declare module mkioplayer {
    ...
    interface Player {
         ...
         */
        downloadableMedia(): mkioplayer.Player.DownloadableMediaFile[];
        downloadableMedia(value: mkioplayer.Player.DownloadableMediaFile[]): Player;
...
        spliceWaiting(): Splice[];
    ...
    export interface MainProgram {
        source: mkioplayer.Player.Source;
        tracks: mkioplayer.Player.Track[];
    }
...
declare module mkioplayer.Player {
 ...
 */
declare module mkioplayer.options.flashSS {
 ...
 */
declare module mkioplayer.options.silverlightSS {
 ...
 */
declare module mkioplayer.options.azureHtml5JS {
 ...
 */
declare function mkioplayer(id: any, options?: mkioplayer.Player.Options, ready?: Function): mkioplayer.Player;
