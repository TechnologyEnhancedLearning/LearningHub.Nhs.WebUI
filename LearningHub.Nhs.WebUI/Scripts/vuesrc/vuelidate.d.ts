// RS 23/1/20: This file contains the TypeScript type definitions for the Vuelidate package. The vuelidate npm package doesnt contain any itself, 
// and the @types/vuelidate package only covers a small proportion of the sourcecode for some reason. I found the below definitions on a github 
// issue report (see half way down https://github.com/vuelidate/vuelidate/issues/175), posted in by another helpful user.
