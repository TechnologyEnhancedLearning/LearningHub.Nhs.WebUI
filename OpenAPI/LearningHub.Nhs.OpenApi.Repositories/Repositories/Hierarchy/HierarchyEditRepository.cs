namespace LearningHub.Nhs.OpenApi.Repositories.Repositories.Hierarchy
{
    ...
    public class HierarchyEditRepository : GenericRepository<HierarchyEdit>, IHierarchyEditRepository
    {
        ...
        {
            return await DbContext.HierarchyEdit.AsNoTracking().FirstOrDefaultAsync(r => r.Id == id && !r.Deleted);
        }
        ...
        {
            return await DbContext.HierarchyEdit.AsNoTracking()
        ...
        public async Task MoveNode(MoveNodeViewModel moveNodeViewModel, int userId)
        {
            ...
            var param2 = new SqlParameter("@p3", SqlDbType.Int) { Value = TimezoneOffsetManager.UserTimezoneOffset ?? (object)DBNull.Value };
        ...
        public async Task<List<MoveResourceResultViewModel>> MoveResource(int sourceNodeId, int destinationNodeId, int resourceId, int userId)
        {
            ...
            var result = await DbContext.MoveResourceResultViewModel.FromSqlRaw("hierarchy.MoveResource @p0, @p1, @p2, @p3, @p4", param0, param1, param2, param3, param4).AsNoTracking().ToListAsync();
            return result;
        }
        ...
        public void SubmitForPublishing(int hierarchyEditId, int userId)
        {
            ...
            DbContext.Database.ExecuteSqlRaw("hierarchy.HierarchyEditSubmitForPublishing @p0, @p1, @p2", param0, param1, param2);
        }
        ...
        public void Publishing(int hierarchyEditId, int userId)
        {
            ...
            DbContext.Database.ExecuteSqlRaw("hierarchy.HierarchyEditPublishing @p0, @p1", param0, param1);
        }
        ...
        public void FailedToPublish(int hierarchyEditId, int userId)
        {
            ...
            DbContext.Database.ExecuteSqlRaw("hierarchy.HierarchyEditFailedToPublish @p0, @p1", param0, param1);
        }
    }
}
