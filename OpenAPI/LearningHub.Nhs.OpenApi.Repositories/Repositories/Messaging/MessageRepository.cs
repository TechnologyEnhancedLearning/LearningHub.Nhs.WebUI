    ...
    public class MessageRepository : GenericRepository<Message>, IMessageRepository
    {
        ...
        public async Task CreateEmailAsync(int userId, string subject, string body, int recipientUserId)
        {
            try
            {
                ...
                await DbContext.Database.ExecuteSqlRawAsync("messaging.CreateEmailForUser @p0, @p1, @p2, @p3, @p4", param0, param1, param2, param3, param4);
            }
            catch (Exception ex)
            {
        ...
        public async Task CreateEmailAsync(int userId, string subject, string body, string recipientEmailAddress)
        {
            try
            {
                ...
                await DbContext.Database.ExecuteSqlRawAsync("messaging.CreateEmailForEmailAddress @p0, @p1, @p2, @p3, @p4", param0, param1, param2, param3, param4);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
            ...
            int notificationType)
        {
            try
            {
                ...
                await DbContext.Database.ExecuteSqlRawAsync("messaging.CreateNotificationForUser @p0, @p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8", param0, param1, param2, param3, param4, param5, param6, param7, param8);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public IQueryable<FullMessageDto> GetPendingMessages()
        {
            ...
            return DbContext.FullMessageDto.FromSqlRaw("messaging.GetPendingMessages @p0", param0);
        }
        ...
        public async Task MessageSendSuccess(int userId, List<int> messageSends)
        {
            try
            {
                ...
                await DbContext.Database.ExecuteSqlRawAsync("messaging.MessageSendSuccess @p0, @p1", param0, param1);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public async Task MessageSendFailure(int userId, List<int> messageSends)
        {
            try
            {
                ...
                await DbContext.Database.ExecuteSqlRawAsync("messaging.MessageSendFailed @p0, @p1", param0, param1);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
