namespace LearningHub.Nhs.OpenApi.Repositories.Repositories.Resources
{
    ...
    public class EmbeddedResourceVersionRepository : GenericRepository<EmbeddedResourceVersion>, IEmbeddedResourceVersionRepository
    {
        ...
        {
            return await DbContext.EmbeddedResourceVersion.AsNoTracking()
        ...
        public async new Task UpdateAsync(int userId, EmbeddedResourceVersion embeddedResourceVersion)
        {
            ...
            var embeddedResourceVersionUpdate = DbContext.EmbeddedResourceVersion
            ...
            if (embeddedResourceVersionUpdate != null)
            {
                ...
                SetAuditFieldsForUpdate(userId, embeddedResourceVersionUpdate);
            }
