namespace LearningHub.Nhs.OpenApi.Repositories.Repositories.Resources
{
    ...
    public class ResourceVersionEventRepository : GenericRepository<ResourceVersionEvent>, IResourceVersionEventRepository
    {
        ...
        {
            return DbContext.ResourceVersionEvent.Where(r => r.ResourceVersionId == resourceVersionId && !r.Deleted).AsNoTracking()
        ...
        {
            return DbContext.ResourceVersionEvent.Where(r => r.ResourceVersionId == resourceVersionId
