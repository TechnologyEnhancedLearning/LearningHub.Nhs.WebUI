namespace LearningHub.Nhs.OpenApi.Repositories.Repositories.Resources
{
    ...
    public class ResourceVersionRepository : GenericRepository<ResourceVersion>, IResourceVersionRepository
    {
        ...
        public async Task<ResourceVersion> GetCurrentForResourceReferenceIdAsync(int resourceReferenceId)
        {
            ...
            if (or != null)
            {
                retVal = await GetCurrentForResourceAsync(or.ResourceId);
            }
        ...
        public async Task<ResourceVersion> GetCurrentResourceForResourceReferenceIdAsync(int resourceReferenceId)
        {
            ...
            if (or != null)
            {
                retVal = await GetCurrentResourceDetailsAsync(or.ResourceId);
            }
        ...
        public async Task<ResourceVersion> GetCurrentPublicationForResourceReferenceIdAsync(int resourceReferenceId)
        {
            ...
            if (rr != null)
            {
                retVal = await GetCurrentPublicationForResourceAsync(rr.ResourceId);
            }
