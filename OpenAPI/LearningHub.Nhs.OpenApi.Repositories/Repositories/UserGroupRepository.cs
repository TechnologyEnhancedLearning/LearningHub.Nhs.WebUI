namespace LearningHub.Nhs.OpenApi.Repositories.Repositories
{
    ...
    public class UserGroupRepository : GenericRepository<UserGroup>, IUserGroupRepository
    {
        ...
        {
            return await DbContext.UserGroup.AsNoTracking().FirstOrDefaultAsync(n => n.Id == id);
        }
        ...
        {
            return await DbContext.UserGroup.AsNoTracking().FirstOrDefaultAsync(n => n.Name == name);
        }
        ...
        {
            return DbContext.Set<UserGroup>()
