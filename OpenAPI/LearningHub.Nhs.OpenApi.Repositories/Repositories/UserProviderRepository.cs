namespace LearningHub.Nhs.OpenApi.Repositories.Repositories
{
    ...
    public class UserProviderRepository : GenericRepository<UserProvider>, IUserProviderRepository
    {
        ...
        {
            return await DbContext.UserProvider.AsNoTracking().FirstOrDefaultAsync(n => n.Id == id && !n.Deleted);
        }
        ...
        {
            return await DbContext.UserProvider.Include(n => n.Provider).AsNoTracking()
        ...
        {
            var existingUserProviders = DbContext.UserProvider.Where(n => n.UserId == userProviderUpdateModel.UserId);
            ...
            if (userProviderUpdateModel.ProviderIds != null)
            {
                foreach (var providerId in userProviderUpdateModel.ProviderIds)
                {
                    ...
                    if (existingUserProvider == null)
                    {
                        ...
                        SetAuditFieldsForCreate(userProviderUpdateModel.UserId, userProvider);
                        DbContext.UserProvider.Add(userProvider);
                    }
                }
            }
