namespace LearningHub.Nhs.OpenApi.Services.Interface.Services
{
    ...
    public interface IDashboardService
    {
        ...
        /// <returns>A <see cref="Task{TResult}"/> representing the result of the asynchronous operation.</returns>
        Task<DashboardMyLearningResponseViewModel> GetMyCoursesAndElearning(GetMyCoursesAndElearningRequestModel requestModel, int userId, string resourceType);
        ...
        Task<MyLearningActivitiesDetailedViewModel> GetMyInprogressLearningAsync(string dashboardTrayLearningResourceType, int pageNumber, int userId, string email);
        ...
        /// <returns>The <see cref="Task"/>.</returns>
        Task<MyLearningCertificatesDetailedViewModel> GetUserCertificateDetailsAsync(string dashboardTrayLearningResourceType, int pageNumber, int userId, string email);
