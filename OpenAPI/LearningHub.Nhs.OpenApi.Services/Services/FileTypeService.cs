namespace LearningHub.Nhs.OpenApi.Services.Services
{
    ...
    public class FileTypeService : IFileTypeService
    {
        ...
        {
            return await fileTypeRepository.GetByIdAsync(id);
        }
        ...
        {
            var fileTypes = await fileTypeRepository.GetAll()
                .ToListAsync();

            return mapper.Map<List<FileTypeViewModel>>(fileTypes);
        }
        ...
        public async Task<FileType> GetByFilename(string filename)
        {
            ...
            {
                return await fileTypeRepository.GetAll().FirstOrDefaultAsync(x => x.Extension == extension);
            }
        ...
        {
            return fileTypeRepository.GetAll().Where(x => x.NotAllowed).Select(x => x.Extension).ToList();
        }
    }
}
