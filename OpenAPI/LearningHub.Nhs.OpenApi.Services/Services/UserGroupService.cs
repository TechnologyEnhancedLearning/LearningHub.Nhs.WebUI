namespace LearningHub.Nhs.OpenApi.Services.Services
{
    ...
    public class UserGroupService : IUserGroupService
    {
        ...
        {
            var validationResult = await ValidateAsync(userGroup);

            if (validationResult.IsValid)
            {
                validationResult.CreatedId = await userGroupRepository.CreateAsync(userId, userGroup);
            }
        ...
        public async Task<LearningHubValidationResult> DeleteAsync(int userId, int userGroupId)
        {
            ...
            try
            {
                await userGroupRepository.DeleteAsync(userId, userGroupId);
        ...
        public async Task<LearningHubValidationResult> ValidateAsync(UserGroup userGroup)
        {
            ...
            if (retVal.IsValid)
            {
                var ug = await userGroupRepository.GetByNameAsync(userGroup.Name);
                if (ug != null)
                {
                    if (userGroup.IsNew()
        ...
        {
            var userGroup = await userGroupRepository.GetByIdAsync(id, true);

            var model = mapper.Map<UserGroupAdminDetailViewModel>(userGroup);
        ...
        {
            var vm = await roleUserGroupRepository.GetRoleUserGroupViewModelsByUserGroupId(userGroupId);
        ...
        {
            var vm = await roleUserGroupRepository.GetRoleUserGroupViewModelsByUserId(userId);
        ...
        {
            var ug = await userGroupRepository.GetByNameAsync(userGroupAdminDetailViewModel.Name);
            if (ug != null)
            {
            ...
            if (retVal.IsValid)
            {
                retVal.CreatedId = await userGroupRepository.CreateAsync(currentUserId, userGroup);
            }
        ...
        public async Task<LearningHubValidationResult> UpdateUserGroupAsync(UserGroupAdminDetailViewModel userGroupAdminDetailViewModel, int currentUserId)
        {
            ...
            var userGroup = await userGroupRepository.GetByIdAsync(userGroupAdminDetailViewModel.Id);
            ...
            if (retVal.IsValid)
            {
                await userGroupRepository.UpdateAsync(currentUserId, userGroup);
            }
        ...
        public async Task<LearningHubValidationResult> AddUserGroupAttribute(UserGroupAttributeViewModel userGroupAttribute, int currentUserId)
        {
            ...
            var existing = await userGroupAttributeRepository.GetByUserGroupIdAttributeId(userGroupAttribute.UserGroupId, userGroupAttribute.AttributeId);
            if (existing != null)
            {
            ...
            try
            {
                var entity = mapper.Map<UserGroupAttribute>(userGroupAttribute);
                int id = await userGroupAttributeRepository.CreateAsync(currentUserId, entity);
        ...
        {
            var entity = await userGroupAttributeRepository.GetByIdAsync(userGroupAttribute.UserGroupAttributeId);
            ...
            entity.Deleted = true;
            await userGroupAttributeRepository.UpdateAsync(currentUserId, entity);
        ...
        public async Task<LearningHubValidationResult> AddRoleUserGroups(List<RoleUserGroupUpdateViewModel> roleUserGroups, int currentUserId)
        {
            ...
            try
            {
                foreach (var roleUserGroup in roleUserGroups)
                {
                    ...
                    {
                        int scopeId;
                        var scope = await scopeRepository.GetByCatalogueNodeIdAsync(roleUserGroup.CatalogueNodeId);
                        if (scope == null)
                        {
                            scope = new Scope() { ScopeType = ScopeTypeEnum.Catalogue, CatalogueNodeId = roleUserGroup.CatalogueNodeId };
                            scopeId = await scopeRepository.CreateAsync(currentUserId, scope);
                        }
                        else
                        {
                            scopeId = scope.Id;

                            var rug = await roleUserGroupRepository.GetByRoleIdUserGroupIdScopeIdAsync(roleUserGroup.RoleId, roleUserGroup.UserGroupId, scopeId);
                            if (rug != null)
                            {
                ...
                {
                    await roleUserGroupRepository.CreateAsync(currentUserId, roleUserGroup);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            var userUserGroup = await userUserGroupRepository.GetByIdAsync(userUserGroupViewModel.Id);
            ...
            await userUserGroupRepository.UpdateAsync(currentUserId, userUserGroup);
        ...
        {
            var roleUserGroup = await roleUserGroupRepository.GetByIdAsync(roleUserGroupViewModel.Id);
            ...
            {
                var catalogue = catalogueService.GetBasicCatalogue(roleUserGroup.Scope.CatalogueNodeId.Value);
                ...
                roleUserGroup.Scope.ScopeType == ScopeTypeEnum.Catalogue)
            {
                ...
                {
                    var roleUserGroups = await roleUserGroupRepository.GetByRoleIdCatalogueId(roleUserGroup.RoleId, catalogue.NodeId);
            ...
            await roleUserGroupRepository.UpdateAsync(currentUserId, roleUserGroup);
        ...
        public async Task<PagedResultSet<RoleUserGroupViewModel>> GetRoleUserGroupAdminFilteredPage(int page, int pageSize, string sortColumn = "", string sortDirection = "", string presetFilter = "", string filter = "")
        {
            ...
            var items = roleUserGroupRepository.GetAll();
            ...
            result.Items = await mapper.ProjectTo<RoleUserGroupViewModel>(items).ToListAsync();
        ...
        public async Task<PagedResultSet<UserUserGroupViewModel>> GetUserUserGroupAdminFilteredPage(int page, int pageSize, string sortColumn = "", string sortDirection = "", string presetFilter = "", string filter = "")
        {
            ...
            var items = userUserGroupRepository.GetAll();
            ...
            result.Items = await mapper.ProjectTo<UserUserGroupViewModel>(items).ToListAsync();
        ...
        public async Task<PagedResultSet<UserGroupAdminBasicViewModel>> GetUserGroupAdminBasicPageAsync(int page, int pageSize, string sortColumn = "", string sortDirection = "", string presetFilter = "", string filter = "")
        {
            ...
            var items = userGroupRepository.GetAll();
            ...
            result.Items = await mapper.ProjectTo<UserGroupAdminBasicViewModel>(items).ToListAsync();
