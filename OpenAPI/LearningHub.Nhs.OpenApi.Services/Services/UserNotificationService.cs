namespace LearningHub.Nhs.OpenApi.Services.Services
{
    ...
    public class UserNotificationService : IUserNotificationService
    {
        ...
        {
            return await usernotificationRepository.GetByIdAsync(id);
        }
        ...
        {
            return await usernotificationRepository.GetByNotificationAndUserIdAsync(userId, notificationId);
        }
        ...
        {
            return await usernotificationRepository.GetUserUnreadNotificationCountAsync(userid);
        }
        ...
        public async Task<LearningHubValidationResult> UpdateAsync(int userId, UserNotification notification)
        {
            ...
            notification.ReadOnDate = notification.ReadOnDate.HasValue ? timezoneOffsetManager.ConvertToUserTimezone(notification.ReadOnDate.Value) : null;
            await usernotificationRepository.UpdateAsync(userId, notification);
        ...
        public async Task<LearningHubValidationResult> CreateAsync(int userId, UserNotification notification)
        {
            ...
            var currentNotification = await usernotificationRepository.GetByNotificationAndUserIdAsync(notificationUserId, notification.NotificationId);
            ...
            await usernotificationRepository.CreateAsync(userId, notification);
            result.IsValid = true;
            return result;
        }
            ...
            int userId, NotificationPriorityEnum priorityType, int page, int pageSize, string sortColumn = "", string sortDirection = "")
        {
            ...
            var items = usernotificationRepository.GetAllNonDismissed(userId, priorityType, sortColumn, sortDirection);
