namespace LearningHub.Nhs.Api.Controllers
{
    ...
    public class ContentController : OpenApiControllerBase
    {
        ...
        {
            await this.pageService.DiscardAsync(pageId, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
        ...
        {
            await this.pageService.PublishAsync(pageId, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
        ...
        {
            await this.pageService.CloneAsync(pageSectionId, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
        ...
        {
            await this.pageService.ChangeOrderAsync(requestViewModel, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
        ...
        {
            await this.pageService.HideAsync(pageSectionId, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
        ...
        {
            await this.pageService.UnHideAsync(pageSectionId, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
        ...
        {
            await this.pageService.DeleteAsync(pageSectionId, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
        ...
        {
            var responseViewModel = await this.pageService.GetEditablePageSectionDetailByPageSectionIdAsync(id, this.CurrentUserId.GetValueOrDefault());
            return this.Ok(responseViewModel);
        }
        ...
        {
            var pageSectionId = await this.pageService.CreatePageSectionAsync(requestViewModel, this.CurrentUserId.GetValueOrDefault());
        ...
        {
            await this.pageService.UpdatePageImageSectionDetailAsync(pageId, model, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
        ...
        {
            var vr = await this.pageService.SaveVideoAssetAsync(requestViewModel, this.CurrentUserId.GetValueOrDefault());
            if (vr.IsValid)
            {
        ...
        {
            var vr = await this.pageService.SaveAttributeFileDetails(requestViewModel, this.CurrentUserId.GetValueOrDefault());
            if (vr.IsValid)
            {
                return this.Ok(new ApiResponse(true, vr));
            }
        ...
        {
            viewModel.AmendUserId = this.CurrentUserId.GetValueOrDefault();
        ...
        {
            await this.pageService.UpdatePageSectionDetailsAsync(requestViewModel, this.CurrentUserId.GetValueOrDefault());
            return this.Ok();
        }
    }
}
