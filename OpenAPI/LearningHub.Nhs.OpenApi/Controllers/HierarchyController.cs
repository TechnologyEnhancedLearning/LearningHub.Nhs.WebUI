namespace LearningHub.NHS.OpenAPI.Controllers
{
    ...
    public class HierarchyController : OpenApiControllerBase
    {
        ...
        {
            var retVal = await hierarchyService.GetNodeDetails(nodeId);
        ...
        {
            var retVal = await hierarchyService.GetNodePathNodes(nodePathId);
        ...
        {
            return this.Ok(await hierarchyService.GetNodeContentsAdminAsync(nodeId, readOnly));
        }
        ...
        {
            return this.Ok(await hierarchyService.GetNodePathsForNodeAsync(nodeId));
        }
        ...
        {
            var folder = await hierarchyService.GetFolderAsync(nodeVersionId);
        ...
        public async Task<IActionResult> CreateHierarchyEdit(int rootNodeId)
        {
            try
            {
                int hierarchyEditId = await this.hierarchyService.CreateHierarchyEdit(rootNodeId, this.CurrentUserId.GetValueOrDefault());
        ...
        public async Task<IActionResult> DiscardHierarchyEdit(int hierarchyEditId)
        {
            try
            {
                var retVal = await this.hierarchyService.DiscardHierarchyEdit(hierarchyEditId, this.CurrentUserId.GetValueOrDefault());
        ...
        public async Task<IActionResult> CreateFolder(FolderEditViewModel folderEditViewModel)
        {
            try
            {
                var retVal = await this.hierarchyService.CreateFolder(folderEditViewModel, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> UpdateFolder(FolderEditViewModel folderEditViewModel)
        {
            try
            {
                var retVal = await this.hierarchyService.UpdateFolder(folderEditViewModel, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> DeleteFolder(int hierarchyEditDetailId)
        {
            try
            {
                var retVal = await this.hierarchyService.DeleteFolder(hierarchyEditDetailId, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> MoveNodeUp(int hierarchyEditDetailId)
        {
            try
            {
                var retVal = await this.hierarchyService.MoveNodeUp(hierarchyEditDetailId, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> MoveNodeDown(int hierarchyEditDetailId)
        {
            try
            {
                var retVal = await this.hierarchyService.MoveNodeDown(hierarchyEditDetailId, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> MoveNode(MoveNodeViewModel moveNodeViewModel)
        {
            try
            {
                var retVal = await this.hierarchyService.MoveNode(moveNodeViewModel, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HierarchyEditMoveResourceUp(int hierarchyEditDetailId)
        {
            try
            {
                var retVal = await this.hierarchyService.HierarchyEditMoveResourceUp(hierarchyEditDetailId, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HierarchyEditMoveResourceDown(int hierarchyEditDetailId)
        {
            try
            {
                var retVal = await this.hierarchyService.HierarchyEditMoveResourceDown(hierarchyEditDetailId, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> HierarchyEditMoveResource(HierarchyEditMoveResourceViewModel moveResourceViewModel)
        {
            try
            {
                var retVal = await this.hierarchyService.HierarchyEditMoveResource(moveResourceViewModel, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> MoveResourceUp(int nodeId, int resourceId)
        {
            try
            {
                var retVal = await this.hierarchyService.MoveResourceUp(nodeId, resourceId, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> MoveResourceDown(int nodeId, int resourceId)
        {
            try
            {
                var retVal = await this.hierarchyService.MoveResourceDown(nodeId, resourceId, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> MoveResource(int sourceNodeId, int destinationNodeId, int resourceId)
        {
            try
            {
                var retVal = await this.hierarchyService.MoveResource(sourceNodeId, destinationNodeId, resourceId, this.CurrentUserId.GetValueOrDefault());
                return this.Ok(new ApiResponse(true, retVal));
            }
            catch (Exception ex)
            {
