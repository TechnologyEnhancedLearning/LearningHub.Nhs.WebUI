namespace LearningHub.Nhs.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class MyLearningController : OpenApiControllerBase
    {
        /// <summary>
        ...
        {
            var activityModel = await this.myLearningService.GetActivityDetailed(this.CurrentUserId.GetValueOrDefault(), requestModel);
        ...
        {
            var segments = await this.myLearningService.GetPlayedSegments(this.CurrentUserId.GetValueOrDefault(), resourceId, majorVersion);
