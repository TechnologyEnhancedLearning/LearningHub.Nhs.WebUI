namespace LearningHub.Nhs.Api.Controllers
{
    ...
    public class SearchController : ApiControllerBase
    {
        ...
        {
            var vr = await this.searchService.SubmitFeedbackAsync(searchFeedbackModel, this.CurrentUserId);
        ...
        {
            var vr = await this.searchService.CreateResourceSearchActionAsync(searchActionResourceModel, this.CurrentUserId);
        ...
        {
            var vr = await this.searchService.CreateCatalogueSearchActionAsync(searchActionCatalogueModel, this.CurrentUserId);
        ...
        {
            LearningHubValidationResult validationResult = await this.searchService.CreateSearchTermEvent(searchRequestModel, this.CurrentUserId);
        ...
        {
            LearningHubValidationResult validationResult = await this.searchService.CreateCatalogueSearchTermEvent(catalogueSearchRequestModel, this.CurrentUserId);
        ...
        {
            var results = await this.searchService.GetSearchResultAsync(searchRequestModel, this.CurrentUserId);
        ...
        {
            var results = await this.searchService.GetCatalogueSearchResultAsync(catalogueSearchRequestModel, this.CurrentUserId);
