...
You now need to <b><a href="[PasswordValidateUrl]">add a password</a></b>.<br/><br/>  
...
For support: <ul>  <li>Visit the <a href="https://support.learninghub.nhs.uk/support/home">Support pages</a> for login guidance, learning resources, and contribution options. </li>  <li>If you have any issues or questions, contact us via the <a href="[SupportFormUrl]">Support Form</a>.</li>  <li>Use Live Chat (look for the icon in the bottom right of your browser) to connect directly with the Support Team.</li>  </ul>  Thank you for registering, we hope you enjoy your learning experience.<br/><br/>  
...
If this was not you, contact us using the following <a href="[SupportFormUrl]">Support Form</a>.<br/><br/> You sign in using this email address: [EmailAddress]. You now need to <b><a href="[PasswordValidateUrl]">add a password</a></b>.<br/><br/>  
In the unlikely event that selecting the above link does not work, please copy and paste this directly into the address bar of your browser: [PasswordValidateUrl]<br/><br/>  
Note that this link has a time limit of [TimeLimit]. If you select the link after this time you will receive instructions on how to generate a new one.<br/><br/>  
...
SET body = '<p style ="color: #007bff">This is an automated email, please do not reply to this address</p>
Dear [FullName],<br/><br/>  
We received a request to retrieve your password for the Learning Hub.<br/><br/>  
