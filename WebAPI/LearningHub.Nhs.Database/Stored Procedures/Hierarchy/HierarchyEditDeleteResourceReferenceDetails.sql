...
-- Author       Dave Brown
-- Created      01-09-2024
-- Purpose      Remove resource reference details within a Hierarchy Edit.
--
-- Modification History
--
-- 01-09-2024  DB	Initial Version.
-------------------------------------------------------------------------------
CREATE PROCEDURE [hierarchy].[HierarchyEditDeleteResourceReferenceDetails] 
(
...
BEGIN
	...
	BEGIN TRY
		...
		SET		ResourceReferenceDisplayVersionId = NULL,
