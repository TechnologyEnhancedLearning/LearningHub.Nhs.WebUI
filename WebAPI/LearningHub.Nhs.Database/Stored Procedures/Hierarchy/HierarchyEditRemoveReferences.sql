...
-- Created      24-07-2024
-- Purpose      Remove references within a Hierarchy Edit.
--
-- Modification History
--
-- 24-07-2024  SA	Initial Revision.
-------------------------------------------------------------------------------
CREATE PROCEDURE [hierarchy].[HierarchyEditRemoveReferences] 
(
...
BEGIN
	...
	BEGIN TRY
		...
		FROM
			[hierarchy].[HierarchyEditDetail] hed
		INNER JOIN
			[hierarchy].[HierarchyEditDetail] hed_remove ON hed.HierarchyEditId = hed_remove.HierarchyEditId AND hed.ParentNodeId = hed_remove.ParentNodeId
		WHERE	
			hed_remove.Id = @HierarchyEditDetailId
