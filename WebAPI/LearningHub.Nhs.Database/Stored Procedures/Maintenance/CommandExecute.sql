CREATE PROCEDURE [maintenance].[CommandExecute]
...
BEGIN
  ...
  IF @LogToTable = 'Y'
  BEGIN
    INSERT INTO maintenance.CommandLog (DatabaseName, SchemaName, ObjectName, ObjectType, IndexName, IndexType, StatisticsName, PartitionNumber, ExtendedInfo, CommandType, Command, StartTime)
