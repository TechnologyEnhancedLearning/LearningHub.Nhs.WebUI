CREATE PROCEDURE [messaging].[CreateEmailForEmailAddress]
(
...
BEGIN
	BEGIN TRY
		BEGIN TRAN
			...
			VALUES (@MessageId, 1, @AmendDate, @UserId, @AmendDate, @UserId, 0);

			SELECT @MessageSendId = SCOPE_IDENTITY();

			INSERT INTO [messaging].[MessageSendRecipient] (EmailAddress, MessageSendId, CreateDate, CreateUserId, AmendDate, AmendUserId, Deleted)
			VALUES (@EmailAddress, @MessageSendId, @AmendDate, @UserId, @AmendDate, @UserId, 0);
