...
-- 11 Jul 2024  PT  Extract certification logic to GetAchievedcertificatedResourcesWithOptionalPagination so logic can have one source of truth
-------------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN
		EXEC [resources].[GetAchievedcertificatedResourcesWithOptionalPagination] @UserId = @UserId, @MaxRows= @MaxRows, @OffsetRows = @OffsetRows, @FetchRows = @FetchRows, @TotalRecords = @TotalRecords;
	END
