// <copyright file="MediaResourceActivityInteractionRepository.cs" company="NHS England">
...
namespace LearningHub.Nhs.Repository.Activity
{
    ...
    public class MediaResourceActivityInteractionRepository : GenericRepository<MediaResourceActivityInteraction>, IMediaResourceActivityInteractionRepository
    {
        ...
        {
            return this.DbContext.MediaResourceActivityInteraction.Where(n => n.Id == id).SingleOrDefaultAsync();
        }
        ...
        {
            var resourceVersion = this.DbContext.ResourceVersion.FirstOrDefault(x => x.Id == resourceVersionId);
            ...
            await this.DbContext.Database.ExecuteSqlRawAsync("activity.CalculatePlayedMediaSegments @p0, @p1, @p2, @p3, @p4, @p5", param0, param1, param2, param3, param4, param5);
        }
    }
}
