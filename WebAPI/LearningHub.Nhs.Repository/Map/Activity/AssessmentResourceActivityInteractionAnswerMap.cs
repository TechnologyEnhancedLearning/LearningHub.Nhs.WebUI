// <copyright file="AssessmentResourceActivityInteractionAnswerMap.cs" company="HEE.nhs.uk">
...
namespace LearningHub.Nhs.Repository.Map.Activity
{
    ...
    public class AssessmentResourceActivityInteractionAnswerMap : BaseEntityMap<AssessmentResourceActivityInteractionAnswer>
    {
        ...
        protected override void InternalMap(EntityTypeBuilder<AssessmentResourceActivityInteractionAnswer> modelBuilder)
        {
            ...
            modelBuilder.HasOne(e => e.MatchedQuestionAnswer)
                .WithMany()
                .HasForeignKey(d => d.MatchedQuestionAnswerId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_AssessmentResourceActivityInteractionAnswer_MatchedQuestionAnswerId");
