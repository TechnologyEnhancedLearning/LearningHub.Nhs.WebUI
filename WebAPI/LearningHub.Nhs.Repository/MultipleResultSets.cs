// <copyright file="MultipleResultSets.cs" company="NHS England">
    ...
    public static class MultipleResultSets
    {
        ...
        public class MultipleResultSetWrapper
        {
            ...
            public MultipleResultSetWrapper(DbContext dbContext, SqlCommand storedProcedure)
            {
                ...
                this.command = storedProcedure;
                this.resultSets = new List<Func<DbDataReader, IEnumerable>>();
            }
            ...
            {
                this.resultSets.Add(reader => MapToList<TResult>(reader));
