// <copyright file="UserRepository.cs" company="NHS England">
...
namespace LearningHub.Nhs.Repository
{
    ...
    public class UserRepository : GenericRepository<User>, IUserRepository
    {
        ...
        {
            return await this.DbContext.User.FirstOrDefaultAsync(n => n.Id == id);
        }
        ...
        {
            return await this.DbContext.User.Include(u => u.UserUserGroup)
        ...
        public async Task<User> GetByUsernameAsync(string username, bool includeRoles)
        {
            ...
            {
                return await this.DbContext.User.FirstOrDefaultAsync(n => n.UserName == username);
            }
        }
