// <copyright file="RoleTestData.cs" company="NHS England">
...
namespace LearningHub.Nhs.Services.UnitTests.TestData
{
    ...
    internal class RoleTestData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleTestData"/> class.
        /// </summary>
        /// <param name="dbContext">The db context.</param>
        internal RoleTestData(LearningHubDbContext dbContext)
        {
        ...
        internal void Setup()
        {
            ...
            userGroup1.RoleUserGroup.Add(new RoleUserGroup() { Role = role1, UserGroup = userGroup1, AmendUserId = 4, AmendDate = DateTimeOffset.Now, CreateUserId = 4, CreateDate = DateTimeOffset.Now });
            ...
            role2.PermissionRole.Add(new PermissionRole() { Role = role2, PermissionId = permission21.Id, Permission = permission21 });
            role2.PermissionRole.Add(new PermissionRole() { Role = role2, PermissionId = permission22.Id, Permission = permission22 });
            ...
            userGroup2.RoleUserGroup.Add(new RoleUserGroup() { RoleId = role1.Id, Role = role1, UserGroup = userGroup2, AmendUserId = 4, AmendDate = DateTimeOffset.Now, CreateUserId = 4, CreateDate = DateTimeOffset.Now });
            userGroup2.RoleUserGroup.Add(new RoleUserGroup() { Role = role2, UserGroup = userGroup2, AmendUserId = 4, AmendDate = DateTimeOffset.Now, CreateUserId = 4, CreateDate = DateTimeOffset.Now });
