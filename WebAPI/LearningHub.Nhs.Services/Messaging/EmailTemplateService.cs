// <copyright file="EmailTemplateService.cs" company="NHS England">
...
namespace LearningHub.Nhs.Services.Messaging
{
    ...
    public class EmailTemplateService : IEmailTemplateService
    {
        ...
        {
            var emailTemplate = this.emailTemplateRepository.GetTemplate((int)EmailTemplates.CatalogueAccessRequest);
            ...
            foreach (var emailModel in emailModels)
            {
                ...
                var body = this.Replace(emailBody, replacementDict);
        ...
        {
            var emailTemplate = this.emailTemplateRepository.GetTemplate((int)EmailTemplates.CatalogueAccessRequestSuccess);
            var emailBody = this.Replace(emailTemplate.EmailTemplateLayout.Body, new Dictionary<string, string>
            {
                ["Content"] = emailTemplate.Body,
            });
        ...
        {
            var emailTemplate = this.emailTemplateRepository.GetTemplate((int)EmailTemplates.CatalogueAccessRequestFailure);
            var emailBody = this.Replace(emailTemplate.EmailTemplateLayout.Body, new Dictionary<string, string>
            {
                ["Content"] = emailTemplate.Body,
            });
        ...
        {
            var emailTemplate = this.emailTemplateRepository.GetTemplate((int)EmailTemplates.CatalogueAccessInvitation);
            var emailBody = this.Replace(emailTemplate.EmailTemplateLayout.Body, new Dictionary<string, string>
            {
                ["Content"] = emailTemplate.Body,
            });
        ...
        {
            var emailTemplate = this.emailTemplateRepository.GetTemplate((int)EmailTemplates.EmailChangeConfirmationEmail);
            var emailBody = this.Replace(emailTemplate.EmailTemplateLayout.Body, new Dictionary<string, string>
            {
                ["Content"] = emailTemplate.Body,
            });
        ...
        {
            var emailTemplate = this.emailTemplateRepository.GetTemplate((int)EmailTemplates.EmailVerified);
            var emailBody = this.Replace(emailTemplate.EmailTemplateLayout.Body, new Dictionary<string, string>
            {
                ["Content"] = emailTemplate.Body,
            });
