namespace LearningHub.Nhs.Services
{
    ...
    public class ResourceService : IResourceService
    {
        ...
        private readonly IScormResourceVersionManifestRepository scormResourceVersionManifestRepository;
        private readonly IResourceVersionValidationResultRepository resourceVersionValidationResultRepository;
        private readonly IResourceAzureMediaAssetRepository resourceAzureMediaAssetRepository;
        ...
        private readonly IExternalReferenceUserAgreementRepository externalReferenceUserAgreementRepository;
        ...
        /// </param>
        /// <param name="resourceSyncService">
        /// The resource sync service.
        /// </param>
        /// <param name="catalogueService">
        ...
        /// </param>
        /// <param name="catalogueNodeVersionRepository">
        /// The catalogue node version repository.
        /// </param>
        /// <param name="resourceVersionRepository">
        /// The resource version repository.
        /// </param>
        /// <param name="resourceVersionAuthorRepository">
        /// The resource version author repository.
        /// </param>
        /// <param name="resourceVersionKeywordRepository">
        /// The resource version keyword repository.
        /// </param>
        /// <param name="resourceVersionEventRepository">
        /// The resource version event repository.
        /// </param>
        /// <param name="resourceVersionFlagRepository">
        /// The resource version flag repository.
        /// </param>
        /// <param name="articleResourceVersionRepository">
        /// The article resource version repository.
        /// </param>
        /// <param name="assessmentResourceVersionRepository">
        /// The assessment resource version repository.
        /// </param>
        /// <param name="articleResourceVersionFileRepository">
        /// The article resource version file repository.
        /// </param>
        /// <param name="embeddedResourceVersionRepository">
        /// The embedded resource version repository.
        /// </param>
        /// <param name="equipmentResourceVersionRepository">
        /// The equipment resource version repository.
        /// </param>
        /// <param name="webLinkResourceVersionRepository">
        ...
        /// </param>
        /// <param name="videoResourceVersionRepository">
        /// The video resource version repository.
        /// </param>
        /// <param name="audioResourceVersionRepository">
        /// The audio resource version repository.
        /// </param>
        /// <param name="scormResourceVersionRepository">
        /// The scorm resource version repository.
        /// </param>
        /// <param name="scormResourceVersionManifestRepository">
        /// The scorm resource version manifest repository.
        /// </param>
        /// <param name="resourceVersionValidationResultRepository">
        /// The resource version validation result repository.
        /// </param>
        /// <param name="fileChunkDetailRepository">
        /// The file chink detail repository.
        /// </param>
        /// <param name="fileRepository">
        /// The file repository.
        /// </param>
        /// <param name="resourceLicenceRepository">
        /// The resource licence repository.
        /// </param>
        /// <param name="publicationRepository">
        /// The publication repository.
        /// </param>
        /// <param name="resourceAzureMediaAssetRepository">
        /// resource azure mediaasset repository.
        /// </param>
        /// <param name="resourceVersionUserAcceptanceRepository">
        /// resource version user acceptance repository.
        /// </param>
        /// <param name="searchService">
        /// The search service.
        /// </param>
        /// <param name="resourceSyncRepository">
        ...
        /// </param>
        /// <param name="caseResourceVersionRepository">
        /// The case resource version repository.
        /// </param>
        /// <param name="wholeSlideImageRepository">
        /// The wholeSlideImage repository.
        /// </param>
        /// <param name="videoRepository">
        /// The video repository.
        /// </param>
        /// <param name="blockCollectionRepository">
        /// The block collection repository.
        /// </param>
        /// <param name="cachingService">
        /// The cache service.
        /// </param>
        /// <param name="fileTypeRepository">
        /// The file type repository.
        /// </param>
        /// <param name="externalReferenceUserAgreementRepository">
        /// The external reference user agreement repository.
        /// </param>
        ...
        /// The node repository.
        /// </param>
        /// <param name="questionBlockRepository">
        /// The question block repository.
        /// </param>
        /// <param name="dbContext">
        /// The database context.
        /// </param>
        /// <param name="migrationSourceRepository">
        /// The migration source repository.
        /// </param>
        /// <param name="bookmarkRepository">
        /// bookmarkRepository.
        /// </param>
        /// <param name="assessmentResourceActivityMatchQuestionRepository">
        /// The assessmentResourceActivityMatchQuestionRepository repository.
        /// </param>
        /// <param name="resourceVersionProviderRepository">
        /// The resourceVersionProviderRepository repository.
        /// </param>
        /// <param name="internalSystemService">The internalSystemService.</param>
        /// <param name="providerService">The providerService.</param>
        public ResourceService(
            ...
            IResourceVersionAuthorRepository resourceVersionAuthorRepository,
            IResourceVersionKeywordRepository resourceVersionKeywordRepository,
            IResourceVersionEventRepository resourceVersionEventRepository,
            IResourceVersionFlagRepository resourceVersionFlagRepository,
            IArticleResourceVersionRepository articleResourceVersionRepository,
            IArticleResourceVersionFileRepository articleResourceVersionFileRepository,
            IAssessmentResourceVersionRepository assessmentResourceVersionRepository,
            IEmbeddedResourceVersionRepository embeddedResourceVersionRepository,
            ...
            IScormResourceVersionManifestRepository scormResourceVersionManifestRepository,
            IResourceVersionValidationResultRepository resourceVersionValidationResultRepository,
            IFileChunkDetailRepository fileChunkDetailRepository,
            IFileRepository fileRepository,
            IResourceLicenceRepository resourceLicenceRepository,
            IPublicationRepository publicationRepository,
            IResourceAzureMediaAssetRepository resourceAzureMediaAssetRepository,
            IResourceVersionUserAcceptanceRepository resourceVersionUserAcceptanceRepository,
            ...
            ICaseResourceVersionRepository caseResourceVersionRepository,
            IWholeSlideImageRepository wholeSlideImageRepository,
            IVideoRepository videoRepository,
            IBlockCollectionRepository blockCollectionRepository,
            ICachingService cachingService,
            IFileTypeRepository fileTypeRepository,
            IExternalReferenceUserAgreementRepository externalReferenceUserAgreementRepository,
            ...
            IAssessmentResourceActivityMatchQuestionRepository assessmentResourceActivityMatchQuestionRepository,
            IResourceVersionProviderRepository resourceVersionProviderRepository,
            ...
            IProviderService providerService)
        {
            ...
            this.scormResourceVersionManifestRepository = scormResourceVersionManifestRepository;
            ...
            this.resourceAzureMediaAssetRepository = resourceAzureMediaAssetRepository;
            ...
            this.mapper = mapper;
            this.externalReferenceUserAgreementRepository = externalReferenceUserAgreementRepository;
        ...
        public async Task<int> PublishResourceVersionAsync(PublishViewModel publishViewModel)
        {
            // IT1: Validate that active node path exists to the resource version.
            var currentResourceVersion = await this.resourceVersionRepository.GetBasicByIdAsync(publishViewModel.ResourceVersionId);
            var nodeResource = (await this.nodeResourceRepository.GetByResourceIdAsync(currentResourceVersion.ResourceId)).FirstOrDefault();

            if (nodeResource == null)
            {
                string errorDetails = $"ResourceService_PublishResourceVersionAsync: Error - a NodeResource record is required.";
                var rve = new ResourceVersionEventViewModel()
                {
                ...
                this.CreateResourceVersionEvent(rve);
                throw new Exception("errorDetails");
            }

            var activeNodePath = (await this.nodePathRepository.GetNodePathsForNodeId(nodeResource.NodeId))
                .Where(np => np.IsActive).FirstOrDefault();

            if (activeNodePath == null)
            {
                string errorDetails = $"ResourceService_PublishResourceVersionAsync: Error - an active NodePath to the Resource is required.";
                var rve = new ResourceVersionEventViewModel()
                {
                    ResourceVersionId = publishViewModel.ResourceVersionId,
                    ResourceVersionEventType = ResourceVersionEventTypeEnum.Publishing,
            ...
            // Publish the ResourceVersion
            var currentUserId = publishViewModel.UserId;
            var publicationId = this.resourceVersionRepository.Publish(publishViewModel.ResourceVersionId, publishViewModel.IsMajorRevision, publishViewModel.Notes, publishViewModel.PublicationDate, currentUserId);
            var (success, resourceReferenceId) = await this.SubmitResourceVersionToSearchAsync(publishViewModel.ResourceVersionId, currentUserId);

            if (success)
            {
                try
                {
                    var resourceVersion = await this.resourceVersionRepository.GetBasicByIdAsync(publishViewModel.ResourceVersionId);

                    if (await this.IsAudioVideoResource(publishViewModel.ResourceVersionId, resourceVersion.Resource.ResourceTypeEnum))
                    {
                        var publishingStartEvent = await this.resourceVersionEventRepository.GetByResourceVersionIdAsync(publishViewModel.ResourceVersionId)
                                                .Where(e => e.ResourceVersionEventType == ResourceVersionEventTypeEnum.Publishing)
                                                .OrderBy(t => t.AmendDate)
                                                .FirstOrDefaultAsync();

                        if (publishingStartEvent != null && (DateTimeOffset.Now - publishingStartEvent.AmendDate) > TimeSpan.FromSeconds(this.settings.Notifications.PublishResourceTimeToProcessInSec))
                        {
                            var notificationId = await this.notificationService.CreateResourcePublishedNotificationAsync(currentUserId, resourceVersion.Title, resourceReferenceId);

                            if (notificationId > 0)
                            {
                                await this.userNotificationService.CreateAsync(currentUserId, new UserNotification { UserId = resourceVersion.AmendUserId, NotificationId = notificationId });
                            }
                        }
                    }

                    if (resourceVersion.Resource.ResourceTypeEnum == ResourceTypeEnum.Scorm)
                    {
                        await this.RemoveExternalReferenceFromCache(resourceVersion.Resource);
                    }
                }
                catch (Exception ex)
                {
                    var rve = new ResourceVersionEventViewModel()
                    {
                        ResourceVersionId = publishViewModel.ResourceVersionId,
                        ResourceVersionEventType = ResourceVersionEventTypeEnum.Publishing,
                        Details = $"ResourceService_PublishResourceVersionAsync: Error sending notification after publish: {ex.Message}",
                ...
                // Make extended resource version view model available in the cache.
                await this.GetResourceVersionExtendedViewModelAsync(publishViewModel.ResourceVersionId, currentUserId);

                // Refresh cached NodeContents data that has been affected by the publication.
                // IT1/2 - publication log only contains "Node" entries for Nodes that have had a change to their "NodeResourceLookup" information.
                ...
                foreach (var o in cacheOperationList)
                {
                    ...
                    if (o.NodeId > 1)
                    {
                        string cacheKey = $"{CacheKeys.PublishedNodeContents}:{o.NodeId}";

                        // Add to cache from db (note - use repository).
                        var nodeContents = await this.nodeRepository.GetNodeContentsForCatalogueBrowse(o.NodeId, false);
                        await this.cachingService.SetAsync(cacheKey, nodeContents);
                    }
                }

                // Ensure cache refresh for the Publication location (IT1/2)
                // Note: required since "NodeResourceLookup" information will not have changed for subsequent publish in the same location.
                var publishedNodeResource = (await this.nodeResourceRepository.GetByResourceIdAsync(currentResourceVersion.ResourceId)).FirstOrDefault(nr => nr.VersionStatusEnum == VersionStatusEnum.Published);
                if (publishedNodeResource.NodeId > 1)
                {
                    if (!cacheOperationList.Select(c => c.NodeId).Contains(publishedNodeResource.NodeId))
                    {
                        string cacheKey = $"{CacheKeys.PublishedNodeContents}:{publishedNodeResource.NodeId}";
                        var nodeContents = await this.nodeRepository.GetNodeContentsForCatalogueBrowse(publishedNodeResource.NodeId, false);
                        await this.cachingService.SetAsync(cacheKey, nodeContents);
                    }
                }
        ...
        /// <summary>
        /// The method to confirm the record has been submitted to search.
        /// </summary>
        ...
        public void ConfirmSubmissionToSearch(int publicationId, int currentUserId)
        {
            try
            {
                var pubication = this.publicationRepository.GetById(publicationId);
                pubication.SubmittedToSearch = true;
                this.publicationRepository.Update(currentUserId, pubication);
            }
            catch
            {
                throw;
        ...
        /// <param name="publishViewModel">The publishViewModel<see cref="PublishViewModel"/>.</param>
        /// <returns>The <see cref="Task{LearningHubValidationResult}"/>.</returns>
        public async Task<LearningHubValidationResult> SubmitResourceVersionForPrepare(PublishViewModel publishViewModel)
        {
            if (publishViewModel.UserId == 0)
            {
                return new LearningHubValidationResult(false, "Operation to submit a resource version for preparation to publish requires a UserId");
            }
            ...
            try
            {
                ...
                var resourcePublishQueue = internalSystem.IsOffline ? $"{this.settings.ResourcePublishQueueRouteName}-temp" : this.settings.ResourcePublishQueueRouteName;
                await this.queueCommunicatorService.SendAsync(resourcePublishQueue, publishViewModel);
            }
            catch (Exception ex)
            {
                string message = "Failed to submit 'prepare' message to 'ResourcePublisher' queue.";
        ...
        /// <param name="publishViewModel">The publishViewModel<see cref="PublishViewModel"/>.</param>
        /// <returns>The <see cref="Task{LearningHubValidationResult}"/>.</returns>
        public LearningHubValidationResult SetResourceVersionPublishing(PublishViewModel publishViewModel)
        {
            if (publishViewModel.UserId == 0)
            {
                return new LearningHubValidationResult(false, "Operation to set a resource version to publishing requires a UserId");
            }

            this.resourceVersionRepository.Publishing(publishViewModel.ResourceVersionId, publishViewModel.UserId);
            return new LearningHubValidationResult(true);
        }

        /// <summary>
        /// Set resource version to publishing failed.
        /// </summary>
        /// <param name="publishViewModel">The publishViewModel<see cref="PublishViewModel"/>.</param>
        /// <returns>The <see cref="Task{LearningHubValidationResult}"/>.</returns>
        public async Task<LearningHubValidationResult> SetResourceVersionFailedToPublish(PublishViewModel publishViewModel)
        {
            var currentUserId = publishViewModel.UserId;
            if (currentUserId == 0)
            {
                return new LearningHubValidationResult(false, "Operation to set a resource version to publishing failed requires a UserId");
            }

            this.resourceVersionRepository.FailedToPublish(publishViewModel.ResourceVersionId, currentUserId);

            var resourceVersion = await this.resourceVersionRepository.GetBasicByIdAsync(publishViewModel.ResourceVersionId);

            var errorList = this.resourceVersionEventRepository.GetByResourceVersionIdAndEventTypeAsync(publishViewModel.ResourceVersionId, ResourceVersionEventTypeEnum.PublishFailure).Select(e => e.Details).ToList();
            ...
            try
            {
                ...
                {
                    notificationId = await this.notificationService.CreatePublishFailedNotificationAsync(
                                currentUserId, resourceVersion.Title);
                }
                else
                {
                    var errorMessage = string.Join("<BR />", errorList);
                    notificationId = await this.notificationService.CreatePublishFailedNotificationAsync(
                                                currentUserId, resourceVersion.Title, errorMessage);
                }

                if (notificationId > 0)
                {
                    await this.userNotificationService.CreateAsync(
                                currentUserId, new UserNotification { UserId = resourceVersion.AmendUserId, NotificationId = notificationId });
                }
            }
            catch (Exception ex)
            {
                var rve = new ResourceVersionEventViewModel()
                {
                    ResourceVersionId = publishViewModel.ResourceVersionId,
                    ResourceVersionEventType = ResourceVersionEventTypeEnum.Publishing,
                    Details = $"ResourceService_SetResourceVersionFailedToPublish: Error sending notification after resource failed to publish: {ex.Message}",
                    CreateUserId = currentUserId,
                };
        ...
        public async Task<List<string>> GetObsoleteResourceFile(int resourceVersionId, bool deletedResource = false)
        {
            ...
            if (resourceVersion != null)
            {
                if (resourceVersion.ResourceType == ResourceTypeEnum.Assessment)
                {
                    ...
                    var allOtherAssessmentBlocks = await this.GetAssessmentBlockCollectionAsync(resourceVersionId, ResourceTypeEnum.Assessment);

                    if (assessmentDetails is { EndGuidance: { } } && assessmentDetails.EndGuidance.Blocks != null)
                    {
                        if (deletedResource)
                        {
                            endGuidanceFiles = this.CheckBlockFile(allOtherAssessmentBlocks.Item2, assessmentDetails.EndGuidance);
                        }
                        else
                        {
                            endGuidanceFiles = this.CheckBlockFile(assessmentDetails.EndGuidance, allOtherAssessmentBlocks.Item2);
                        }
                    ...
                    if (assessmentDetails is { AssessmentContent: { } } && assessmentDetails.AssessmentContent.Blocks != null)
                    {
                        if (deletedResource)
                        {
                            assessmentContentFiles = this.CheckBlockFile(allOtherAssessmentBlocks.Item1, assessmentDetails.AssessmentContent);
                        }
                        else
                        {
                            assessmentContentFiles = this.CheckBlockFile(assessmentDetails.AssessmentContent, allOtherAssessmentBlocks.Item1);
                        }
                ...
                else if (resourceVersion.ResourceType == ResourceTypeEnum.Case)
                {
                    ...
                    var allBlocks = await this.GetAllCaseBlockCollectionsAsync(resourceVersionId, ResourceTypeEnum.Case);
                    if (deletedResource)
                    {
                        caseFiles = this.CheckBlockFile(allBlocks, caseDetails.BlockCollection);
                    }
                    else
                    {
                        caseFiles = this.CheckBlockFile(caseDetails.BlockCollection, allBlocks);
                    }
        ...
        /// <param name="userId">The userId<see cref="int"/>.</param>
        /// <returns>The <see cref="Task{LearningHubValidationResult}"/>.</returns>
        public async Task<LearningHubValidationResult> UpdateEmbeddedResourceVersionAsync(EmbedCodeViewModel embedCodeViewModel, int userId)
        {
            var e = this.mapper.Map<EmbeddedResourceVersion>(embedCodeViewModel);
            var validator = new EmbeddedResourceVersionValidator();

            var vr = await validator.ValidateAsync(e);
            if (vr.IsValid)
            {
                await this.embeddedResourceVersionRepository.UpdateAsync(userId, e);
            }
        ...
        /// <returns>The <see cref="Task"/>.</returns>
        public async Task<BlockCollectionViewModel> GetAllCaseBlockCollectionsAsync(int excludeResourceVersionId, ResourceTypeEnum resourceType)
        {
            var blockList = new List<BlockViewModel>();
            var collection = await this.blockCollectionRepository.GetAllBlockCollections(excludeResourceVersionId, resourceType);
            if (collection != null && collection.Item1 != null)
            {
                var blocks = this.mapper.Map<BlockCollectionViewModel>(collection.Item1);
                if (blocks.Blocks.Any())
                {
                    blockList.AddRange(blocks.Blocks);
                }
            }

            return new BlockCollectionViewModel { Blocks = blockList };
        }
        ...
        /// <param name="resourceVersionId">The resource version id.</param>
        /// <returns>The <see cref="Task"/>.</returns>
        public async Task<AssessmentResourceVersion> GetAssessmentBasicDetailsByIdAsync(int resourceVersionId)
        {
            var assessmentResourceVersion = await this.assessmentResourceVersionRepository.GetByResourceVersionIdAsync(resourceVersionId);

            return assessmentResourceVersion;
        }
        ...
        /// <returns>The <see cref="Task"/>.</returns>
        public async Task<Tuple<BlockCollectionViewModel, BlockCollectionViewModel>> GetAssessmentBlockCollectionAsync(int excludeResourceVersionId, ResourceTypeEnum resourceType)
        {
            var collection = await this.blockCollectionRepository.GetAllBlockCollections(excludeResourceVersionId, resourceType);

            var assessmentBlocks = new List<BlockViewModel>();
            var endGuidanceBlocks = new List<BlockViewModel>();

            if (collection != null)
            {
                if (collection.Item2 != null)
                {
                    var assessmentContentBlocks = this.mapper.Map<BlockCollectionViewModel>(collection.Item2);
                    if (assessmentContentBlocks.Blocks.Any())
                    {
                        assessmentBlocks.AddRange(assessmentContentBlocks.Blocks);
                    }
                }

                if (collection.Item3 != null)
                {
                    var endGuidanceBlocksView = this.mapper.Map<BlockCollectionViewModel>(collection.Item3);
                    if (endGuidanceBlocksView.Blocks.Any())
                    {
                        endGuidanceBlocks.AddRange(endGuidanceBlocksView.Blocks);
                    }
                }
            }

            return new Tuple<BlockCollectionViewModel, BlockCollectionViewModel>(
                new BlockCollectionViewModel { Blocks = assessmentBlocks },
                new BlockCollectionViewModel { Blocks = endGuidanceBlocks });
        }
        ...
        /// <returns>The <see cref="Task"/>.</returns>
        public async Task<AssessmentViewModel> GetAssessmentContentUpToQuestion(int resourceVersionId, int questionNumber, List<int> answerOrders)
        {
            ...
            var assessmentQuestions = assessmentContentViewModel.Blocks.Where(block => block.BlockType == BlockType.Question).ToList();
            assessmentQuestions.Sort((q1, q2) => q1.Order.CompareTo(q2.Order));

            if (questionNumber > assessmentQuestions.Count())
            {
                questionNumber = assessmentQuestions.Count();
            }

            if (questionNumber == assessmentQuestions.Count)
            {
                assessmentViewModel.AssessmentContent =
                    HideAssessmentDetailsHelper.NullifyItemsFromBlock(
                        assessmentContentViewModel,
                        assessmentContentViewModel.Blocks.Count,
                        assessmentViewModel.AnswerInOrder);
            }
            else
            {
                assessmentViewModel.AssessmentContent =
                    HideAssessmentDetailsHelper.NullifyItemsAfterQuestion(assessmentContentViewModel, questionNumber, assessmentViewModel.AnswerInOrder);
            }
        ...
        /// <param name="userId">The userId<see cref="int"/>.</param>
        /// <returns>The <see cref="Task{LearningHubValidationResult}"/>.</returns>
        public async Task<LearningHubValidationResult> UpdateFileDetailsAsync(FileUpdateRequestViewModel fileUpdateRequestViewModel, int userId)
        {
            var file = await this.fileRepository.GetByIdAsync(fileUpdateRequestViewModel.FileId);
            if (file == null)
            {
                return new LearningHubValidationResult(false, "File not found");
            }

            file.FilePath = fileUpdateRequestViewModel.FilePath;

            await this.fileRepository.UpdateAsync(userId, file);
        ...
        public async Task<LearningHubValidationResult> RecordExternalReferenceUserAgreementAsync(ExternalReferenceUserAgreementViewModel viewModel, int currentUserId)
        {
            var result = new LearningHubValidationResult();
            var externalReferenceUserAgreement = this.mapper.Map<ExternalReferenceUserAgreement>(viewModel);
            result.CreatedId = await this.externalReferenceUserAgreementRepository.CreateAsync(currentUserId, externalReferenceUserAgreement);
            result.IsValid = true;
            return result;
        }
        ...
        /// The update scorm detail async.
        /// </summary>
        /// <param name="scormViewModel">The scormViewModel<see cref="ScormUpdateRequestViewModel"/>.</param>
        /// <returns>The <see cref="Task{LearningHubValidationResult}"/>.</returns>
        public async Task<LearningHubValidationResult> UpdateScormPublishDetailAsync(ScormPublishUpdateViewModel scormViewModel)
        {
            var scorm = await this.scormResourceVersionRepository.GetByResourceVersionIdAsync(scormViewModel.ResourceVersionId);
            var result = new LearningHubValidationResult();
        ...
        /// <returns>The <see cref="Task{LearningHubValidationResult}"/>.</returns>
        public async Task<LearningHubValidationResult> SetScormManifestDetailAsync(ScormManifestUpdateRequestViewModel scormManifestViewModel)
        {
            try
            {
                var scormManifest = await this.scormResourceVersionManifestRepository.GetByScormResourceVersionIdAsync(scormManifestViewModel.ScormResourceVersionId);

                if (scormManifest != null)
                {
                    scormManifest.Deleted = true;
                    await this.scormResourceVersionManifestRepository.UpdateAsync(scormManifestViewModel.AmendUserId, scormManifest);
                }

                scormManifest = this.mapper.Map<ScormResourceVersionManifest>(scormManifestViewModel);
                await this.scormResourceVersionManifestRepository.CreateAsync(scormManifestViewModel.AmendUserId, scormManifest);
            }
            catch
            {
            }
        ...
        public async Task<MediaAssetInputViewModel> GetMediaAssetInputViewModelAsync(int resourceVersionId)
        {
            var retVal = new MediaAssetInputViewModel();
            var rv = await this.resourceVersionRepository.GetBasicByIdAsync(resourceVersionId);

            retVal.ResourceVersionId = rv.Id;
            retVal.ResourceTypeEnum = rv.Resource.ResourceTypeEnum;
            retVal.UserId = rv.AmendUserId;

            if (rv.Resource.ResourceTypeEnum == ResourceTypeEnum.Video)
            {
                var videoDetails = await this.GetVideoDetailsByIdAsync(rv.Id);
                retVal.FileName = videoDetails.File.FileName;
                retVal.FilePath = videoDetails.File.FilePath;
                retVal.VideoResourceVersionId = videoDetails.Id;
            }

            if (rv.Resource.ResourceTypeEnum == ResourceTypeEnum.Audio)
            {
                var audioDetails = await this.GetAudioDetailsByIdAsync(rv.Id);
                retVal.FileName = audioDetails.File.FileName;
                retVal.FilePath = audioDetails.File.FilePath;
                retVal.AudioResourceVersionId = audioDetails.Id;
            }
        ...
        /// <returns>The <see cref="int"/>.</returns>
        public async Task<int> CreateResourceAzureMediaAssetAsync(MediaAssetOutputViewModel model)
        {
            var resourceAzureMediaAssetEntity = this.mapper.Map<ResourceAzureMediaAsset>(model);

            int resourceAzureMediaAssetId = await this.resourceAzureMediaAssetRepository.CreateAsync(model.UserId, resourceAzureMediaAssetEntity);

            if (resourceAzureMediaAssetId > 0)
            {
                if (model.VideoResourceVersionId > 0)
                {
                    var videoResourceVersion = await this.videoResourceVersionRepository.GetByIdAsync(model.VideoResourceVersionId);
                    videoResourceVersion.ResourceAzureMediaAssetId = resourceAzureMediaAssetId;
                    videoResourceVersion.AmendUserId = model.UserId;
                    videoResourceVersion.DurationInMilliseconds = model.DurationInMilliseconds;
                    await this.videoResourceVersionRepository.UpdateAsync(model.UserId, videoResourceVersion);
                }
                else if (model.AudioResourceVersionId > 0)
                {
                    var audioResourceVersion = await this.audioResourceVersionRepository.GetByIdAsync(model.AudioResourceVersionId);
                    audioResourceVersion.ResourceAzureMediaAssetId = resourceAzureMediaAssetId;
                    audioResourceVersion.AmendUserId = model.UserId;
                    audioResourceVersion.DurationInMilliseconds = model.DurationInMilliseconds;
                    await this.audioResourceVersionRepository.UpdateAsync(model.UserId, audioResourceVersion);
                }
            }

            return resourceAzureMediaAssetId;
        }
        ...
        {
            return await this.nodeResourceRepository.GetAllPublishedResourceAsync();
        }
        ...
        /// <param name="userId">The user id.</param>
        /// <returns>The <see cref="Task{LearningHubValidationResult}"/>.</returns>
        public async Task<LearningHubValidationResult> DeleteResourceVersionProviderAsync(int providerId, int resourceVersionId, int userId)
        {
            try
            {
                await this.resourceVersionProviderRepository.DeleteAsync(resourceVersionId, providerId, userId);
                return new LearningHubValidationResult(true);
            }
            catch (Exception ex)
            {
        ...
        private async Task RemoveExternalReferenceFromCache(Resource resource)
        {
            ...
            var contentServerUrl = new Uri(this.settings.LearningHubContentServerUrl).GetLeftPart(UriPartial.Authority);
        ...
        {
            var createNotification = resourceType == ResourceTypeEnum.Audio || resourceType == ResourceTypeEnum.Video;

            if (!createNotification && resourceType == ResourceTypeEnum.Article)
            {
                var rv = await this.GetResourceVersionExtendedViewModelAsync(resourceVersionId);

                if (rv.ArticleDetails != null)
                {
                    var fileTypelist = await this.fileTypeRepository.GetAll().ToArrayAsync();

                    createNotification = rv.ArticleDetails.Files.Any(f =>
                    {
                        string extension = System.IO.Path.GetExtension(f.FileName).Replace(".", string.Empty);
                        var resourceTypeId = fileTypelist.FirstOrDefault(x => x.Extension.Equals(extension, StringComparison.InvariantCultureIgnoreCase))?.DefaultResourceTypeId;
                        return resourceTypeId == (int)ResourceTypeEnum.Video || resourceTypeId == (int)ResourceTypeEnum.Audio;
                    });
                }
            }
