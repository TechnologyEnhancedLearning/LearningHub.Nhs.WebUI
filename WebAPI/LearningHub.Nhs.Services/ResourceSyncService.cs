// <copyright file="ResourceSyncService.cs" company="NHS England">
...
namespace LearningHub.Nhs.Services
{
    ...
    public class ResourceSyncService : IResourceSyncService
    {
        ...
        public async Task<LearningHubValidationResult> SyncForUserAsync(int userId)
        {
            ...
            var mappedResourcesToDelete = resourcesToDelete.Select(x => this.mapper.Map<SearchResourceRequestModel>(x)).ToList();
        ...
        public async Task<LearningHubValidationResult> SyncSingleAsync(int resourceVersionId)
        {
            ...
            {
                await this.findwiseApiFacade.RemoveAsync(new List<SearchResourceRequestModel> { searchResourceRequestModel });
            }
            else
            {
                ...
                await this.findwiseApiFacade.AddOrReplaceAsync(new List<SearchResourceRequestModel> { searchResourceRequestModel });
            }
