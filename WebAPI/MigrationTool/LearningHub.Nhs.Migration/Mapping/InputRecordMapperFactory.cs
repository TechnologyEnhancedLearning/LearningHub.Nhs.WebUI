// <copyright file="InputRecordMapperFactory.cs" company="HEE.nhs.uk">
...
namespace LearningHub.Nhs.Migration.Mapping
{
    ...
    /// <summary>
    /// Returns the correct input record mapper implementation based on the migration source id.
    /// </summary>
    public class InputRecordMapperFactory : IInputRecordMapperFactory
    {
        private readonly IServiceProvider serviceProvider;

        /// <summary>
        /// Initializes a new instance of the <see cref="InputRecordMapperFactory"/> class.
        /// </summary>
        /// <param name="serviceProvider">The serviceProvider.</param>
        public InputRecordMapperFactory(IServiceProvider serviceProvider)
        {
        ...
        /// <returns>The IInputRecordMapper.</returns>
        public IInputRecordMapper GetMapper(int migrationSourceId)
        {
            ...
            if (migrationSourceId >= 1 && migrationSourceId <= 99)
            {
                ...
                return this.serviceProvider.GetService<StandardInputRecordMapper>();
            }
            else if (migrationSourceId >= 100 && migrationSourceId <= 199)
            {
                ...
                return this.serviceProvider.GetService<StagingTableInputRecordMapper>();
            }
            else
            {
                throw new ArgumentException($"Unexpected MigrationSourceId - {migrationSourceId}. This Id has not been set up in LearningHub.Nhs.Migration.Mapping.InputRecordMapperFactory.cs");
            }
        }
    }
}
